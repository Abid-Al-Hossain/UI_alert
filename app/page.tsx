...
export default function Page() {
  const [state, setState] = useState<AlertState>(DEFAULT_ALERT_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Alert Studio" controls={controls} preview={output} /></AppShell>;
}
